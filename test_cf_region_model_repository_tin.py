...
def tin_region_model_repository() -> Any:
    if os.name != 'nt':
        from catchments_simulation.cf_region_model_repository import CFRegionModelRepository
    ...
    return {'region_model_id': 'test',  # a unique name identifier of the simulation
            ...
            'repository': {'class': tin_region_model_repository(),
                           'params': {
                               ...
                               'tin_data_folder': os.path.abspath( '/home/olgasilantyeva/projects/rasputin_workspace/rasputin_data/tin_archive/cal_tins'),
                               'tin_uid': ['cid-0-203.1.0'],  # tin_uid=filename=catchment_id, here use can use list to load all required sub-catchments
                           }},
            }
